/**
 * Source-shape tests for Google Meet silence auto-leave (Q1=A).
 */
...
const recordingTs = fs.readFileSync(
  path.join(__dirname, "platforms/googlemeet/recording.ts"),
  "utf-8",
);

console.log("\n=== Google Meet silence auto-leave ===");
...
expectContains(
  "rejects with GOOGLE_MEET_BOT_INACTIVE_NO_AUDIO_TIMEOUT",
  recordingTs,
  "GOOGLE_MEET_BOT_INACTIVE_NO_AUDIO_TIMEOUT",
);
expectContains(
...
console.log(`\n=== gmeet silence summary: ${passed} passed, ${failed} failed ===`);
